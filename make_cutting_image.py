# -*- coding: utf-8 -*-
"""
Created on Mon Jan 25 21:09:46 2016
...
#            print "train_y_point:", y_point
            ...
            plt.imshow(train_cropped_image, cmap=plt.cm.gray)
            save_path = "C:\\Users\\matsumi\\Desktop\\writer classification\\CVL_ConvNet_pow\\"
            name = name + "_" + str(y)
            saveFilename = save_path + name + ".png"   # name + 新しい拡張子(.png)
            print saveFilename
            skimage.io.imsave(saveFilename, train_cropped_image)
            plt.show()
            plt.draw()
